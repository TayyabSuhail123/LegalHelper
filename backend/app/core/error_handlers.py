...
class APIErrorHandler:
    ...
    @staticmethod
    def handle_validation_error(field_name: str, field_value: Any, constraint: str) -> HTTPException:
    ...
    def validate_file_size(file_size: int, max_size: int) -> bool:
        ...
        if file_size > max_size:
            raise APIErrorHandler.handle_validation_error(
                "file_size",
                file_size,
                f"must not exceed {max_size} bytes"
            )
        return True
...
class error_context:
    ...
    def __init__(self, context: str, file_id: Optional[str] = None):
