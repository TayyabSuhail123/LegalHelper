...
export const HealthApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async detailedHealthCheckApiV1HealthDetailedGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['HealthApi.detailedHealthCheckApiV1HealthDetailedGet']?.[localVarOperationServerIndex]?.url;
...
export class HealthApi extends BaseAPI {
    ...
    public detailedHealthCheckApiV1HealthDetailedGet(options?: RawAxiosRequestConfig) {
        return HealthApiFp(this.configuration).detailedHealthCheckApiV1HealthDetailedGet(options).then((request) => request(this.axios, this.basePath));
    }
